...
export default class FirstPersonPlayer {
    constructor(camera, scene, container = document) {
        ...
        // Increased player size: doubled the capsule dimensions
        this.playerCollider = new Capsule(
            new THREE.Vector3(0, 0.7, 0), // Adjusted start position
            new THREE.Vector3(0, 2, 0),   // Adjusted end position
            0.7                          // Doubled radius
        );
    ...
    teleportPlayerIfOob() {
        if (this.camera.position.y <= -25) {
            // Adjusted for larger player size
